...
import { Bot, Search, Map, Globe, Gamepad2, Chrome, LucideIcon } from "lucide-react";
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          // filter: "url(#glass-distortion)", // Temporarily disabled as SVG filters can be tricky in Next.js/Browser consistency without proper defs
          isolation: "isolate",
        }}
      />
      <div
  ...
  >
    <div className="flex items-center justify-center gap-2 rounded-3xl p-3 py-0 px-0.5 overflow-hidden">
      {icons.map((item, index) => (
        <div key={index} className="flex flex-col items-center justify-center p-2 transition-all duration-700 hover:scale-110 cursor-pointer group">
           <div className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/20 shadow-sm text-gray-800">
